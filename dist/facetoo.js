...
var ShowMoreLessLink = function (index, v2, options) {
    if (index.length > v2) {
        return "<div class=\"gui m-b-5 m-t-5\">"
            ...
            + "class=\"gui caps gui-body-2 simple show-more-link cursor-pointer p-0 m-t-3 arrowkeys-aware\">"
            + (index.length - v2)
            + " More </a>"
            + "<a tabindex=\"0\" aria-label=\"Press enter to show less values\" "
            + "class=\"gui caps gui-body-2 simple show-less-link cursor-pointer gui-hidden p-0 m-t-3 arrowkeys-aware\">"
            + "Show Less</a></div>";
    }
    else {
        return "";
...
__export(__webpack_require__(/*! ../eventhandlers/FacetKeyBoardNavigationHandler */ 34));
...
__export(__webpack_require__(/*! ./Filter */ 36));
...
var Facet = /** @class */ (function () {
    function Facet(options) {
        ...
        this.handlerChain.push(new eventhandlers_1.FacetKeyBoardNavigationHandler(this.facetElement));
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "    <section aria-label=\"Filter Section for "
    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
    + "\" class=\"gui item facet-item "
    ...
    + "\" \r\n            data-attr-name=\""
    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
    + "\">\r\n        <div class=\"content\">\r\n            <div class=\"facet-item-header fluid gui item flex jc-sb\">\r\n                <span   class=\"gui primary gui-subheading-1 caps m-0 expansion-icon cursor-pointer arrowkeys-aware\"\r\n                        title=\""
    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
    ...
    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
    + "\"\r\n                        tabindex=\"0\"></i>\r\n"
    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.collapsed : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams, depths),"inverse":container.program(5, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
    + "                </span>\r\n            </div>\r\n            <div class=\"clear\"></div>\r\n            <div class=\"description gui facet-item-description m-t-10 "
    + alias2(__default(__webpack_require__(/*! ./src/hbs/helpers/Hidden.ts */ 7)).call(alias3,(depth0 != null ? depth0.collapsed : depth0),true,{"name":"Hidden","hash":{},"data":data}))
    + "\"\r\n                id=\"pinned-facet-values-"
    + alias2(alias1((data && data.index), depth0))
    + "\">\r\n                <div class=\"gui facet-label-container fluid-w m-0 p-0\">\r\n"
    + ((stack1 = helpers.each.call(alias3,(depth0 != null ? depth0.facetValues : depth0),{"name":"each","hash":{},"fn":container.program(7, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "                    "
    + ((stack1 = __default(__webpack_require__(/*! ./src/hbs/helpers/ShowMoreLessLink.ts */ 8)).call(alias3,(depth0 != null ? depth0.facetValues : depth0),(depths[1] != null ? depths[1].noOfFacetToShow : depths[1]),{"name":"ShowMoreLessLink","hash":{},"data":data})) != null ? stack1 : "")
    + "\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </section>\r\n";
},"3":function(container,depth0,helpers,partials,data) {
  ...
  return "                    <div class=\"gui item "
    ...
    + " has "
    + alias2(alias3((depth0 != null ? depth0.count : depth0), depth0))
    + " records. Press spacebar to apply this filter.\"\r\n                                class=\"gui cursor-pointer gui-subheading-1 no-wrap text-shorten m-0 arrowkeys-aware\">\r\n                            <input  class=\"gui facet-value-checkbox cursor-pointer m-l-0\" \r\n                                    id=\""
    + alias2(alias3((depth0 != null ? depth0.label : depth0), depth0))
    + "-"
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "<section aria-label=\"All Filters\">\r\n    <div class=\"gui p-10\">\r\n        <span class=\"gui gui-subheading-2 caps bold-500\">\r\n            ALL FILTERS\r\n        </span>\r\n    </div>\r\n"
  ...
  return "    <section aria-label=\"Filter Section for "
    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
    + "\" class=\"gui item facet-item border-bottom light p-r-10 p-t-5 p-b-5 p-l-10 "
    + alias2(__default(__webpack_require__(/*! ./src/hbs/helpers/Collapsed.ts */ 4)).call(alias3,(depth0 != null ? depth0.collapsed : depth0),{"name":"Collapsed","hash":{},"data":data}))
    + "\" \r\n        data-attr-id=\""
    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
    + "\" \r\n        data-attr-name=\""
  ...
  return "                    <div class=\"gui item "
    ...
    + " has "
    + alias2(alias3((depth0 != null ? depth0.count : depth0), depth0))
    + " records\"\r\n                                role=\"option\"\r\n                                class=\"gui gui-subheading-1 cursor-pointer no-wrap text-shorten m-0 arrowkeys-aware\">\r\n                            <input class=\"gui facet-value-checkbox cursor-pointer m-l-0\" \r\n                                    id=\""
    + alias2(alias3((depth0 != null ? depth0.label : depth0), depth0))
    + "-"
    + alias2(alias3((data && data.index), depth0))
    + "\" \r\n                                    "
...
Object.defineProperty(exports, "__esModule", { value: true });
var FacetConstants_1 = __webpack_require__(/*! ./../config/FacetConstants */ 35);
...
Object.defineProperty(exports, "__esModule", { value: true });
var HotKeysFiltersHandler_1 = __webpack_require__(/*! ../eventhandlers/HotKeysFiltersHandler */ 37);
var FilterTemplateService_1 = __webpack_require__(/*! ../services/FilterTemplateService */ 38);
var FilterConfigStore_1 = __webpack_require__(/*! ./../config/FilterConfigStore */ 41);
var eventhandlers_1 = __webpack_require__(/*! ./../eventhandlers */ 13);
...
Object.defineProperty(exports, "__esModule", { value: true });
var FacetSubHeader = __webpack_require__(/*! ./../../hbs/facet-applied-filters.hbs */ 39);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "                <button aria-label=\"Clear Range for filter "
    ...
    + alias2(alias1((depths[1] != null ? depths[1].type : depths[1]), depth0))
    + ":::true\">\n                    "
    + alias2(__default(__webpack_require__(/*! ./src/hbs/helpers/Range.ts */ 40)).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.min : depth0),(depth0 != null ? depth0.max : depth0),(depths[1] != null ? depths[1].type : depths[1]),{"name":"Range","hash":{},"data":data}))
    + "\n                    <i class=\"gui-icon gui-icon-cancel\"></i>\n                </button>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams,depths) {
    var stack1;
