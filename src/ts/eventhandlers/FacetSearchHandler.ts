        ...
        setTimeout(() => {
            ...
            this
                ...
                .each((i: number, e) => {
                    ...
                    const name = facetItem.attr("data-attr-name");
                    ...
                    if (collapsed || facetNameMatch || facetChildMatch) {
                        ExpandCollapseManager.ControlVisibilityOfFilter(headerElment, ShowHide.Show, name);
                    } else {
                        ExpandCollapseManager.ControlVisibilityOfFilter(headerElment, ShowHide.Hide, name);
                    }
                });
